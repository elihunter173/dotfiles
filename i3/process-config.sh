...
# source environment variables used by all other config files first
source $config_dir/envars.i3

# then do arbitrary customization layers
for config in $(find $config_dir/layers -name '*.i3'); do
    source $config
done
